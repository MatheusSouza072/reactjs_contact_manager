    ...
    return (
        <tr>
            {editMode === contact.id ? <>
                ...
                <td>
                    <Button variant="primaryll" onClick={() => setEditMode(0)}>Save</Button>
                </td>
            </>
                : <>
                    <td>{contact.id}</td>
                    ...
                    <td>
                        <Button variant="primary" onClick={() => setEditMode(contact.id)}><i class="fa fa-edit"></i></Button>
                        <Button variant="danger" onClick={() => remove(contact.id)}><i class="fa fa-trash" aria-hidden="true"></i></Button>
                    </td>  
                </> 
            }
        </tr>
